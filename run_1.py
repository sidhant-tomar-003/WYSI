import argparse
from helpers import resolve_path, load_image, run_YOLO, check_result, box_sam2, save_image, get_mask_centers_and_areas, process_centers_with_sam2, create_noun_vector_store, process_masks,save_matching
...
def main():
    ...
    if (len(boxes) > 0):
        ...
        for input_point, ms in result.items():
            ...
            processed_list.extend(process_masks(image, masks, scores, model, preprocess, noun_store))
